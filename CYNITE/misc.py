...
async def imdb_search(client, message):
    if ' ' in message.text:
        ...
        if not movies:
            return await message.reply("𝙉𝙤 𝙍𝙚𝙨𝙪𝙡𝙩𝙨 𝙁𝙤𝙪𝙣𝙙")
        btn = [
            [
        ...
        await k.edit('✧ 𝙏𝙝𝙞𝙨 𝙄𝙨 𝙒𝙝𝙖𝙩 𝙄 𝙁𝙤𝙪𝙣𝙙 𝙊𝙣 𝙄𝙈𝘿𝘽', reply_markup=InlineKeyboardMarkup(btn))
    else:
        await message.reply('✧ 𝙂𝙞𝙫𝙚 𝙈𝙚 𝘾𝙤𝙧𝙧𝙚𝙘𝙩 𝙉𝙖𝙢𝙚 𝙊𝙛 𝙔𝙤𝙪𝙧 𝙍𝙚𝙦𝙪𝙚𝙨𝙩')
